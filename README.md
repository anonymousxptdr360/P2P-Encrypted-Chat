...
![License](https://img.shields.io/badge/License-MIT-green) ![Security](https://img.shields.io/badge/Encryption-AES--256%20%2B%20HMAC-brightgreen) ![Privacy](https://img.shields.io/badge/Logs-Zero%20(RAM%20Only)-orange) ![Protocol](https://img.shields.io/badge/Protocol-WebRTC-blue)
...
* **Anti-XSS (Cross-Site Scripting):** Incoming payloads are treated as untrusted. The application uses strict DOM sanitization (no `innerHTML`) to prevent code execution via malicious messages.
* **Strict File Validation:** Incoming files are checked against a MIME-Type whitelist. Executables disguised as images are rejected.
...
* **Files:** Click the paperclip to send files.
